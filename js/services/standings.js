...
export const PosicionesService = {
    calcularPosiciones(torneoId, categoriaId) {
        ...
        const rows = new Map(teams.map(team => [team.id, { ...team, jugados: 0, ganados: 0, perdidos: 0, puntos: 0 }]));
        ...
        return [...rows.values()].sort((a, b) => b.puntos - a.puntos || b.ganados - a.ganados || a.nombre.localeCompare(b.nombre));
    }
};
